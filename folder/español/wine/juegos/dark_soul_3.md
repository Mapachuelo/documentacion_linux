...
``` 
https://www.nexusmods.com/darksouls3/mods/2174?tab=description
```
Parametro de lanzamiento recomendado:
```
WINEDLLOVERRIDES="d3dcompiler_43=n,b" PROTON_PREFER_SDL=1 PROTON_NTSYNC=1 gamescope -W 1920 -H 1080 -f -- gamemoderun ENABLE_VKBASALT=1 mangohud %command%
```
